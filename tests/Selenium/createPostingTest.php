    ...
    public function tes1AddRootPosting()
    {
        ...
        $this->assertTrue(
            $this->isElementPresent(
                "css=div[class*='thread_line {$thread->getId()} new']"
            )
        );
        ...
        $this->assertTrue(
            $this->isElementPresent(
                "css=div[class*='thread_line {$thread->getId()}']"
            )
        );
        $this->assertFalse(
            $this->isElementPresent(
        ...
        $this->waitForPageToLoad("30000");
        if ($this->isChecked("UserUserAutomaticalyMarkAsRead") == true) {
            $this->click("UserUserAutomaticalyMarkAsRead");
        }
        ...
        $this->assertTrue(
            $this->isElementPresent(
                "css=div[class*='thread_line {$posting->getId()} new']"
            )
        );
        ...
        $this->click("btn_user_edit");
        $this->waitForPageToLoad("30000");
        if ($this->isChecked("UserUserAutomaticalyMarkAsRead") == false) {
            $this->click("UserUserAutomaticalyMarkAsRead");
        }
        $this->click("btn-submit");
        $this->waitForPageToLoad("30000");
