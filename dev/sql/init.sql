...
CREATE TABLE `users` (
  ...
  `user_automaticaly_mark_as_read` tinyint(1) NOT NULL DEFAULT '1',
  `user_sort_last_answer` tinyint(1) NOT NULL DEFAULT '1',
  ...
  `show_recententries` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `user_category_custom` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
