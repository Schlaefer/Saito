...
define(['jquery', 'underscore', 'marionette'], function($, _, Marionette) {
  ...
  var Theme = new Marionette.Application();

  var TopMenuModule = Theme.module('TopMenuModule', function(Module) {
  ...
  var ThemeSwitcherModule = Theme.module('ThemeSwitcherModule',
      function(Module) {
