...
/* User Test cases generated on: 2010-07-08 18:07:56 : 1278607316 */
...
class UserTest extends CakeTestCase {
	...
	public function testValidateCheckOldPassword() {
		...
		$this->assertFalse($this->User->save($data));
		$this->assertTrue(array_key_exists('password_old', $this->User->invalidFields()));
		...
		$this->assertTrue($this->User->save($data));
		$this->assertFalse(array_key_exists('password_old', $this->User->invalidFields()));
	...
	public function testRegister() {
		...
		$expected = array_merge($data['User'], array(
