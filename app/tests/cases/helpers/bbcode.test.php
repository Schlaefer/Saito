...
class BbcodeHelperTestCase extends CakeTestCase {
	...
	public function startCase() {
		...
		$this->Bbcode = ClassRegistry::init('BbcodeHelper', 'helper');

		$this->Bbcode->Html = ClassRegistry::init('HtmlHelper', 'helper');
	...
	public function endCase() {
		...
		Configure::write('Saito.Settings.text_word_maxlength', $this->text_word_maxlength);
